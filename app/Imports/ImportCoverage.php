    ...
    */
    public function model(array $row)
    {
        ...
        return new Coverage([
            ...
            '3-11_child_referred' => $row['3-11_child_referred'],
            '11-59_child_referred' => $row['11-59_child_referred'],
            'total_suspected_adr' => $row['total_suspected_adr'],
    ...
    public function rules():array {
        return [
            ...
            '3-11_child_referred' => 'required',
            '11-59_child_referred' => 'required',
            'total_suspected_adr' => 'required',
